        ...
        <div id="booking-form" className="bg-black p-6 md:p-10 max-w-3xl mx-auto border border-white/15 shadow-2xl relative">
          {submitted ? (
            <div className="text-center py-12 space-y-6 animate-[fadeIn_0.5s_ease-out]">
              <div className="flex items-center justify-center w-16 h-16 mx-auto rounded-full bg-[#C5A059]/10 border border-[#C5A059]/30 text-[#C5A059]">
                <CheckCircle2 className="w-8 h-8 text-[#C5A059]" />
              </div>

              <h3 className="text-xl md:text-2xl font-serif text-[#F2EFE9] max-w-xl mx-auto leading-relaxed">
                Thank you for contacting <span className="text-[#C5A059] font-medium">{formData.name}</span>, our team will connect to you soon.
              </h3>
              ...
              <div className="pt-4">
                <button
                  ...
                  className="text-xs font-cinzel tracking-widest text-[#B8B0A5] hover:text-[#C5A059] uppercase transition-colors border-b border-white/20 hover:border-[#C5A059] pb-1"
                >
